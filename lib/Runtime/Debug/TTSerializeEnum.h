...
// enum keys for the JSON writer
ENTRY_SERIALIZE_ENUM(allocations)
ENTRY_SERIALIZE_ENUM(addInfo)
ENTRY_SERIALIZE_ENUM(addType)
ENTRY_SERIALIZE_ENUM(allocInfo)
ENTRY_SERIALIZE_ENUM(arrayInfo)
ENTRY_SERIALIZE_ENUM(arrIndices)
ENTRY_SERIALIZE_ENUM(buffInfo)
ENTRY_SERIALIZE_ENUM(contexts)
ENTRY_SERIALIZE_ENUM(estimatedSize)
ENTRY_SERIALIZE_ENUM(evalTopLevelScripts)
ENTRY_SERIALIZE_ENUM(fileId)
ENTRY_SERIALIZE_ENUM(filename)
ENTRY_SERIALIZE_ENUM(fileToSourceMap)
ENTRY_SERIALIZE_ENUM(funcBodies)
ENTRY_SERIALIZE_ENUM(function)
ENTRY_SERIALIZE_ENUM(getterSetters)
ENTRY_SERIALIZE_ENUM(hasNoEnumProp)
ENTRY_SERIALIZE_ENUM(isPNRGSeeded)
ENTRY_SERIALIZE_ENUM(loadedTopLevelScripts)
ENTRY_SERIALIZE_ENUM(length)
ENTRY_SERIALIZE_ENUM(mapInfo)
ENTRY_SERIALIZE_ENUM(maybeLongLivedRoot)
ENTRY_SERIALIZE_ENUM(newFunctionTopLevelScripts)
ENTRY_SERIALIZE_ENUM(objArrId)
ENTRY_SERIALIZE_ENUM(objectHandlers)
ENTRY_SERIALIZE_ENUM(objectIds)
ENTRY_SERIALIZE_ENUM(objects)
ENTRY_SERIALIZE_ENUM(objectTypes)
ENTRY_SERIALIZE_ENUM(OptDependsOnInfo)
ENTRY_SERIALIZE_ENUM(optIndexedObjectArray)
ENTRY_SERIALIZE_ENUM(pendingAsyncMods)
ENTRY_SERIALIZE_ENUM(primitives)
ENTRY_SERIALIZE_ENUM(promiseInfo)
ENTRY_SERIALIZE_ENUM(properties)
ENTRY_SERIALIZE_ENUM(randomSeed0)
ENTRY_SERIALIZE_ENUM(randomSeed1)
ENTRY_SERIALIZE_ENUM(rejectReactions)
ENTRY_SERIALIZE_ENUM(rootList)
ENTRY_SERIALIZE_ENUM(runtime)
ENTRY_SERIALIZE_ENUM(scopeInfo)
ENTRY_SERIALIZE_ENUM(scopes)
ENTRY_SERIALIZE_ENUM(source)
ENTRY_SERIALIZE_ENUM(setInfo)
ENTRY_SERIALIZE_ENUM(slotArrays)
ENTRY_SERIALIZE_ENUM(slotInfo)
ENTRY_SERIALIZE_ENUM(subPaths)
ENTRY_SERIALIZE_ENUM(subScopes)
ENTRY_SERIALIZE_ENUM(symbolTable)
